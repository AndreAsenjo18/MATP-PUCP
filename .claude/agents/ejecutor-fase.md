---
name: ejecutor-fase
description: Ejecuta una o varias fases de docs/PROMPT_BASE.md del arranque MATP (specs, backend, modelo de datos, API, backlog, documentación). Úsalo desde el orquestador /bootstrap-matp.
model: opus
---
