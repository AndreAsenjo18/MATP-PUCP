...
Estructura y motivos: [ADR-001](docs/adr/ADR-001-estructura-repo.md). Herramientas y versiones: [ADR-003](docs/adr/ADR-003-herramientas-base.md). Modelo de datos: [docs/modelo-datos.md](docs/modelo-datos.md) y [ADR-004](docs/adr/ADR-004-modelo-datos-auditoria.md).
